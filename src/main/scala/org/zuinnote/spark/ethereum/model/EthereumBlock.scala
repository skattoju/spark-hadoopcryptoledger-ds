...
final case class EthereumTransaction(nonce: Array[Byte], value: BigDecimal, receiveAddress: Array[Byte], gasPrice: BigDecimal,
                                     gasLimit: BigDecimal, data: Array[Byte], sig_v: Array[Byte], sig_r: Array[Byte],
                                     sig_s: Array[Byte])
...
final case class EnrichedEthereumTransaction(nonce: Array[Byte], value: BigDecimal, receiveAddress: Array[Byte],
                                             gasPrice: BigDecimal, gasLimit: BigDecimal, data: Array[Byte], sig_v: Array[Byte],
